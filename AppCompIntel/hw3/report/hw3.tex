...
Table~\ref{tab:confusion_matrix_lda} shows the confusion matrix resulted from the use of the LDA classifier in the dataset. 

\input{../tables/confusion_matrix_lda.tex}
\input{../tables/results_lda.tex}


\input{../tables/confusion_matrix_knnc.tex}
\input{../tables/results_knnc.tex}
\input{../tables/confusion_matrix_svc.tex}
\input{../tables/results_svc.tex}
