...
Regression models try to find relations between the \emph{independent variables}, the predictors in this work, and the \emph{dependent variables}, the outcomes. These relations can occur in different forms, but the more common one is when a linear increase in one represents a linear increase in the other. Relations of this type are comprised by the \emph{Linear Regression}. 
