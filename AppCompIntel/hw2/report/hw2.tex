...
This method tries to find the linear regression between the predictors and outcomes by fitting a line through the data. The fitting is done by minimising a cost function defined by the squared distance between the data and the line to be fitted. The sum of the distances will be minimum in the best fit, what gives the name to the method.
